              ...
              <div>
                <div className='flex'>
                  <img
                    ...
                    src='assets/images/windows-client.png'
                    alt='windows-client'
                  />
                  <h3>What is Powir?</h3>
                </div>
                <div className='p-3'>
                  <p>
                    Powir is a Windows 10/11 based tool to monitor and analyze
                    your system's power and battery usage.
                  </p>
                  <p className='mt-1'>
                    It provides you with various information and statistics
                    about the current and overall history of the power and
                    battery usage of your system.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='w-full lg:w-1/2'>
              <div className=''>
                <div className='flex flex-wrap'>
                  <img
                    className='no-border mr-2'
                    src='assets/images/used-product.png'
                    alt='used-product'
                  />
                  <h3>What it does?</h3>
                </div>
            ...
            <div className='w-full lg:w-1/2'>
              <div className=''>
                <div className='flex'>
                  <img
                    className='no-border mr-2'
                    src='assets/images/hammer--v1.png'
                    alt='hammer--v1'
                  />
                  <h3>Why build it?</h3>
                </div>
        ...
        <div className='w-full'>
          <div className='mt-2'>
            ...
            <div className='mt-3'>
              ...
              <p className='mt-1'>
                Depends, Powir parses the raw reports generated from Windows and
                does the computations of the various statistics and render the
                charts.
              </p>
            </div>
            <div className='mt-3'>
              ...
              <p className='mt-1'>
                Powir runs as an electron app (chromium web engine embedded)
                while using React to facilitate the UI and data workflow.
              </p>
            </div>
            <div className='mt-3'>
              <h4>Does it share my data anywhere?</h4>
              <p className='mt-1'>
                No, Powir will never share your data anywhere outside your local
                system, the entire source code of the app is online for anyone
                to check. Infact, it never makes any request to a server since
                there is none. Its simply a client sided app.
              </p>
            </div>
          </div>
        </div>
