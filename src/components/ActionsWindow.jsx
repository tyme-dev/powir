    ...
    <div>
      <div className='flex flex-wrap border-bottom mt-3 pb-3'>
        <div className='w-full'>
          <h3 className={actionsNote()}>
            Note: Actions are only available via electron app:{' '}
            <a href='https://github.com/SlapBot/powir'>Powir</a>
          </h3>
          ...
          <div className='pt-4 pb-6 border-bottom'>
            <div className='flex'>
              <img
                className='no-border mr-2'
                src='assets/images/code-file.png'
                alt='code-file'
              />
              <h3>Export Data (JSON)</h3>
            </div>
            <p className='mt-2'>
              Export the parsed and processed data of your system from Powir in
              JSON format:
            </p>
            <button
          ...
          <div className='pt-4 pb-6'>
            ...
            <p className='mt-2'>
              ...
              <kbd className='ml-1'>powercfg /batteryreport</kbd> in the
              terminal.
            </p>
            <button
              className='mt-4 btn-warning'
              onClick={showOriginalReport}
              disabled={config.liteMode}
            >
              Display Report
            </button>
